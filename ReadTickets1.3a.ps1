        ...
        <Border Background="White" CornerRadius="10" Padding="10" Margin="20">
            <StackPanel>
                ...
                <StackPanel Orientation="Horizontal" Margin="10">
                    <Button Name="commentAndUpdateB" Content="Add comment and Update" Width="220" Background="#FF4DA3DC" Foreground="White" Padding="5" />
...
"@
    ...
    try {
        ...
        $commentAndUpdateB = $Window.FindName("commentAndUpdateB")
    ...
    <Grid>
        <Border Background="White" CornerRadius="10" Padding="10" Margin="20">
            <StackPanel>
                ...
                <TextBox Name="allUpdatesT" FontSize="15" Height="360" Margin="10,0,10,0" 
...
"@
    ...
    $commentAndupdateB.Add_Click({ 
        ...
        if ( !($Global:comment -eq "") ) {

            $item | Add-Member -type NoteProperty -Name 'Update' -Value $Global:comment
