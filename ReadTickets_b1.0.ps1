...
<Window x:Class="TicketSystem.OpenTicket"
        ...
        mc:Ignorable="d"
        Title="Open ticket" Height="650" Width="800">
    <Grid>
        <Border Background="White" CornerRadius="10" Padding="10" Margin="20">
            <StackPanel>
                ...
                <Label Content="All privius updates"/>
                
                <!-- TextBox för användarinmatning -->
                <TextBox Name="allUpdatesT" FontSize="15" Height="100" Margin="10,0,10,0" 
                     Text="Missing update..." Foreground="#FF757272" 
                ...
                <TextBox Name="updateT" FontSize="15" Height="100" Margin="10,0,10,0" 
...
"@
    ...
    $updateB.Add_Click({ 
        ...
        if ( $updateT.Text -eq $temp ) {
            ...
            if ( $allUpdatesT.Text.lengt -gt 0 ) {
